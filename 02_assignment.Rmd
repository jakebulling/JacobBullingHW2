...
```{r}
levels(lending_training$sub_grade)
...
lending_recipe <- recipe(Class~., 
                         ...
                         step_mutate_at(funded_amnt,
                                        ...
                                        fn = ~ as.numeric()) %>%
                           step_mutate(sub_grade = as.character(grade),
                                       sub_grade = fct_relevel(
                                                  case_when(
                                                  sub_grade %in% "A1":"A5"   ~ "A",
                                                  sub_grade %in% "B1":"B4" ~ "B",
                                                  sub_grade %in% "C1":"C5" ~"C", 
                                                  sub_grade %in% "D1":"D5" ~"D", 
                                                  sub_grade %in% "E1":"E5" ~ "E", 
                                                  sub_grade %in% "F1":"F5" ~"F", 
                                                  sub_grade %in% "G1":"G5" ~ "G", 
                                                  TRUE ~ sub_grade
                        ),
                        "A", "B", "C", "D", "E", "F", "G")))
```
